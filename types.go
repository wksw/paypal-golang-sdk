// Package paypal reference from github.com/plutov/paypal/types.go
package paypal
...
type (
	...
	// PlatformFee https://developer.paypal.com/docs/api/payments/v2/#definition-platform_fee
	PlatformFee struct {
		Amount *Money          `json:"amount,omitempty"`
		Payee  *PayeeForOrders `json:"payee,omitempty"`
	}

	// PaymentInstruction https://developer.paypal.com/docs/api/payments/v2/#definition-payment_instruction
	...
	// SearchShippingInfo search shipping info
	...
	// SearchPayerName search payer name
	SearchPayerName struct {
		GivenName string `json:"given_name"`
		Surname   string `json:"surname"`
	}

	// SearchPayerInfo search payer info
	...
	// SearchTaxAmount search tax amount
	SearchTaxAmount struct {
		TaxAmount Money `json:"tax_amount"`
	}

	// SearchTransactionInfo search transaction info
	...
	// SearchTransactionDetails search transaction details
	...
	// SharedListResponse share list response
